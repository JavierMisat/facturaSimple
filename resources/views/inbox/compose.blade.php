...
@section('page_title')	Compose @stop
@section('page_subtitle')
Bootstrap UI Components
@stop
@section('page_heading')	Compose @stop
	...
	<div class="inbox-container">
			...
			<div class="padding-15">
					<div class="butt-container">
						<a href="/messages/compose"><button class="btn btn-primary btn-block btn-rounded">
							Compose 
						</button></a>
					</div>
	...
	<div class="compose-container">
		<div class="wrap-compose">
			...
			<div class="receipient">
				<strong class="to">TO </strong> @include('widgets.labels', array('class'=>'primary', 'value'=> 'john@doe.com'))
			</div>
			<div class="subject">
			...
			<div class="send-footer">
				@include('widgets.button', array('class'=>'primary', 'rounded'=>true, 'value'=>'Send'))
