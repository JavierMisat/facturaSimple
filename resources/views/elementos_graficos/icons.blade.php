	...
	<div class="col-sm-12">
		...
		<div class="row">
			<div class="fa col-lg-3">
				...
				<p>@include('widgets.icon', array('class'=>'elementos_graficos.home')) fa-home
				...
				<p>@include('widgets.icon', array('class'=>'elementos_graficos.inbox')) fa-inbox
				...
				<p>@include('widgets.icon', array('class'=>'elementos_graficos.calendar')) fa-calendar
			...
			<div class="fa col-lg-3">
				...
				<p>@include('widgets.icon', array('class'=>'elementos_graficos.table')) fa-table
		...
		@endsection
		@include('widgets.panel', array('class'=>'primary icon-page', 'controls'=>true,  'header'=>true, 'as'=>'elementos_graficos.icons'))
	</div>
</div>	
@stop