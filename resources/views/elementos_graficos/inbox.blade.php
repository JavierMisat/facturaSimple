...
@section('page_title') Inbox @stop
@section('page_subtitle')
	Bootstrap UI Components
@stop
@section('page_heading') Inbox @stop
		...
		<div class="wrap-message">	
			<div class="n0-scroll">
				<div class="message-topic">
					<i class="fa fa-star m-r-xs text-primary"></i> Development Files <span class="pull-right text-muted"><a href=""><i class="fa fa-reply"></i></a><a href=""><i class="fa fa-trash-o"></i></span></a>
				</div>
				<div class="message-sender">
					<img class="img-circle sender-img m-r-xs" src="{{ url ('img/profile1.jpg') }}" alt=""> 
