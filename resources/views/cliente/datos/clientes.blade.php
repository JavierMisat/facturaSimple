            ...
            <div class="invoice">
                <div class="row invoice-logo">
                    <div class="col-md-6 dashy-left">
                        <i class="fa fa fa-angle-double-left fa-3x"></i><span
                                    ...
                                    <address>
                                        ...
                                        @if($cliente->telefono != null)
                                            <span class="fa fa-phone">
                                                <a href="mailto:{{$cliente->telefono}}  ">{{$cliente->telefono}}</a></span>
                                            <br>
                                        @endif
                                        ...
                                        @if($cliente->telefono != null)
                                            <span class="fa fa-envelope">
                                                <a href="tel:{{$cliente->correo}}  ">{{$cliente->correo}}</a></span>
                                            <br>
                                        @endif
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @if($cliente->facturasCliente->count() > 0)
                            ...
                            @section ('htable_panel_title','Facturas '.$cliente->nombre_completo)
                        @section ('htable_panel_body')
                            @include('cliente.datos.facturas', array('class' =>'table-hover', 'facturas' => $cliente->facturasCliente()->OrderBy('created_at', 'DESC')->paginate(5)))
                        @endsection
                        @include('widgets.panel', array('class'=>'primary', 'controls'=>true, 'header'=>true, 'as'=>'htable'))
                        @else
                            <h2 class="text-center padder"><i class="fa fa- fa-code fa-1x"></i> Este cliente aún no
                                tiene facturas... </h2>
                            <h2 style="text-align: center;">
                                <a href="/clientes/asignarfactura/{{$cliente->id_cliente or null}}"
                                   class="btn btn-danger btn-group-lg btn-bordered">Agregar Factura <i
                ...
                @section('js_personalizado')
                    {!! Html::script('js/crud/resumen_cliente.js') !!}
                @endsection
                    ...
                    <div class="col-sm-12 invoice-block">
                        <a href="/clientes/{{ $cliente->id_cliente }}/edit/"
                           class="btn btn-rounded btn-primary btn-o hidden-print pull-right">
                            Editar Cliente <i class="fa fa-pencil-square-o"></i>
                        </a> &nbsp;&nbsp;&nbsp;
