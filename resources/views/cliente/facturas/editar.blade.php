    ...
    <div class="row col-sm-offset-3">
        <div class="col-md-8">
            ...
            @section ('test_panel_body')
                ...
                <button class="btn btn-gray btn-lg col-md-3 col-sm-offset-2" onclick="location.href='{{ url('clientes/'.$factura->clienteFactura->id_cliente) }}'" type="button"><i class="fa fa fa-angle-double-left fa-1x"></i> Regresar</button>
