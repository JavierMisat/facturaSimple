            ...
            <div class="invoice">
                                ...
                                <div class="col-md-6">
                                    <address>
                                        ...
                                        <strong class="text-dark"><a
                                                    href="/clientes/{{$factura->clienteFactura->id_cliente}}"><i
                                        ...
                                        <a href="/clientes/facturas/{{$factura->clienteFactura->facturasCliente->last()->id_factura}}">#{{$factura->clienteFactura->facturasCliente->last()->cod_factura}}</a>
                                        <br>
                ...
                <div class="row">
                    <div class="col-sm-12 invoice-block">
                        <a href="/facturas/{{ $factura->id_factura }}/edit/" class="btn btn-rounded btn-primary btn-o hidden-print pull-right">
                        ...
                        <button onclick="location.href='{{ url('facturas') }}'"
